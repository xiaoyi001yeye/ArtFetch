...
/**
 * Operator-triggered data upgrade helper. It is skipped unless explicitly enabled with
 * ARTFETCH_HD_CANONICAL_UPGRADE_ALL=true and should not be used as a normal verification test.
 */
