...
class HdImageCanonicalObjectKeyTest {
    ...
    void canonicalObjectKeyCanBeReadFromRealTosByWorkEnvironmentWithoutImportedImageMetadata() throws Exception {
        ...
        String uploadedKey = canonicalHdImageKey(pathPrefix, "artron", testArtwork.getExternalId());
        ...
        try {
            ...
            String discoveredKey = canonicalHdImageKey(pathPrefix, "artron", workArtwork.getExternalId());
    ...
    private static String canonicalHdImageKey(String pathPrefix, String source, String externalId) {
        return normalizePrefix(pathPrefix)
                + "canonical/"
                + sanitizePathPart(source)
                + "/"
                + sanitizePathPart(externalId)
                + "/hd-lossless.png";
    }
